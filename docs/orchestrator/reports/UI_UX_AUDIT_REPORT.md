...
- **Severity:** Critical
- **Description:** وبما أن W8-T2-NAV-IA من W8-T2-NAV-IA استبدل درجي سائل قائمة الجوانب 32 إلى القوائم 7 (المجموعات nav//لإنشاء اتجاه وإدارة الجهاز/الذاكرة للمستقبل)، على هذا من خصائص ، وتم خفض العرض 60 (W) (240px )
