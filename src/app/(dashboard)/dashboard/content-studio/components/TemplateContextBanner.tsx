    ...
    <Card className="border-sky-200 bg-sky-50/70 shadow-[0_14px_34px_rgba(15,23,42,0.05)]">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="flex min-w-0 gap-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-surface-elevated text-sky-700 ring-1 ring-sky-100">
        ...
        <div className="grid gap-2 rounded-2xl border border-white/80 bg-surface-elevated/80 p-3 text-sm lg:w-72">
          <div>
